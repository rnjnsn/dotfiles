...
enum { SchemeNorm, SchemeSel, SchemeTitleNorm, SchemeTitleSel, SchemeTagsNorm, SchemeTagsSel, SchemeHidNorm, SchemeHidSel, SchemeUrg };
...
ResourcePref resources[] = {
    ...
    { "normbg",          STRING, &normbgcolor },
    { "normborder",      STRING, &normbordercolor },
    { "normfloat",       STRING, &normfloatcolor },
    
    /* Selected colors */
    { "selfg",           STRING, &selfgcolor },
    { "selbg",           STRING, &selbgcolor },
    { "selborder",       STRING, &selbordercolor },
    { "selfloat",        STRING, &selfloatcolor },
    
    /* Title normal colors */
    { "titlenormfg",     STRING, &titlenormfgcolor },
    { "titlenormbg",     STRING, &titlenormbgcolor },
    { "titlenormborder", STRING, &titlenormbordercolor },
    { "titlenormfloat",  STRING, &titlenormfloatcolor },
    
    /* Title selected colors */
    { "titleselfg",      STRING, &titleselfgcolor },
    { "titleselbg",      STRING, &titleselbgcolor },
    { "titleselborder",  STRING, &titleselbordercolor },
    { "titleselfloat",   STRING, &titleselfloatcolor },
    
    /* Tags normal colors */
    { "tagsnormfg",      STRING, &tagsnormfgcolor },
    { "tagsnormbg",      STRING, &tagsnormbgcolor },
    { "tagsnormborder",  STRING, &tagsnormbordercolor },
    { "tagsnormfloat",   STRING, &tagsnormfloatcolor },
    
    /* Tags selected colors */
    { "tagsselfg",       STRING, &tagsselfgcolor },
    { "tagsselbg",       STRING, &tagsselbgcolor },
    { "tagsselborder",   STRING, &tagsselbordercolor },
    { "tagsselfloat",    STRING, &tagsselfloatcolor },
    
    /* Hidden normal colors */
    { "hidnormfg",       STRING, &hidnormfgcolor },
    { "hidnormbg",       STRING, &hidnormbgcolor },
    
    /* Hidden selected colors */
    { "hidselfg",        STRING, &hidselfgcolor },
    { "hidselbg",        STRING, &hidselbgcolor },
    
    /* Urgent colors */
    { "urgfg",           STRING, &urgfgcolor },
    { "urgbg",           STRING, &urgbgcolor },
    { "urgborder",       STRING, &urgbordercolor },
    { "urgfloat",        STRING, &urgfloatcolor },
    
    /* Other DWM preferences */
